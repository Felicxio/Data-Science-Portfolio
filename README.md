...
**[📧 jvictor3651@gmail.com](mailto:jvictor3651@gmail.com)** • **[💼 LinkedIn](https://www.linkedin.com/in/joão-victor-assunção-pereira-88a461211)** • **[🐙 GitHub](https://github.com/Felicxio)**
...
```python
# ML
scikit-learn • XGBoost • LightGBM • Feature Engineering • Validação de Modelos

# Deep Learning  
TensorFlow • PyTorch • Keras • OpenCV • Computer Vision
```

### 🧠 GenAI & LLMs (Diferencial!)
```python
LLMs (GPT, Claude) • RAG (Retrieval-Augmented Generation) 
Langchain • Prompt Engineering • Fine-tuning
```

### 📊 Análise & Visualização
```python
Pandas • Polars • NumPy • Matplotlib • Seaborn • Plotly
Power BI • Excel Avançado (VBA, Power Query, DAX)
```

### 🔄 Engenharia de Dados & MLOps
```python
Databricks • Apache Spark (PySpark) • ETL/ELT • PostgreSQL
Docker • Versionamento de Modelos • Pipelines de ML • APIs
```

### 🤖 Automação
```python
UiPath • n8n • Python Automation • RPA
```
...
### ⚡ [Previsão de Consumo Energético Industrial](./6.%20Portfolio%20-%20Steel%20Industry%20Energy%20Consumption%20ML/)
...
**[📂 Ver Detalhes](./6.%20Portfolio%20-%20Steel%20Industry%20Energy%20Consumption%20ML/)** | **[📓 Notebooks](./6.%20Portfolio%20-%20Steel%20Industry%20Energy%20Consumption%20ML/notebooks/)**
...
**📧 Email:** [jvictor3651@gmail.com](mailto:jvictor3651@gmail.com)  
**💼 LinkedIn:** [João Victor Assunção Pereira](https://www.linkedin.com/in/joão-victor-assunção-pereira-88a461211)  
...
### ⭐ Gostou do meu trabalho? Deixe uma estrela neste repositório!

**Disponível para oportunidades | Remoto ou Híbrido**
...
<sub>**Nota:** Todos os projetos utilizam dados públicos. Código disponível para consulta e aprendizado.</sub>
